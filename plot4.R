plot4 <- function() {
        ...
        #TR
        with(subsetHpc,plot(datetime,Voltage,type="l",ylab = "Voltage",xlab = "datetime",main = ""))
        #BR
        with(subsetHpc,plot(datetime,Global_reactive_power,type="l",xlab = "datetime",main = ""))
